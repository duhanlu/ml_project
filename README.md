...
# Guidance
* **EDA and visualization**:  <u>eda.ipynb</u> detailedly analyze three .csv files we used for our project. There are also graphs and heatmap of data visualization.
